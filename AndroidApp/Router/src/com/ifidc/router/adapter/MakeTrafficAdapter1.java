...
public class MakeTrafficAdapter1 extends BaseAdapter {
	private Activity context;
	private List<MakeTrafficData1> shopitem;
	private int shoplist_item;
	private ImageLoader imageLoader;
	public MakeTrafficAdapter1(Activity context, List<MakeTrafficData1> shopitem,
			int shoplist_item) {
		super();
...
//		TextView textView_distance = null;
		if (convertView == null) {
			...
			textView_title = (TextView) convertView.findViewById(R.id.textView1);
			textView_des = (TextView) convertView.findViewById(R.id.textView2);
