...
public class ModuleContentAdapter1 extends BaseAdapter {
	private Activity context;
	private List<ModuleContentData1> shopitem;
	private int shoplist_item;
	private ImageLoader imageLoader;
	public ModuleContentAdapter1(Activity context, List<ModuleContentData1> shopitem,
			int shoplist_item) {
		super();
